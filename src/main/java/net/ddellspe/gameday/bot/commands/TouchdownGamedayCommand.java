...
@Component
public class TouchdownGamedayCommand implements MessageResponseCommand {
  @Override
  ...
  public Mono<Void> handle(MessageCreateEvent event) {
    ...
    if (manager.isStarted()) {
      GamedayAudioManager.PLAYER_MANAGER.loadItemOrdered(
          manager,
          manager.getConfiguration().getTouchdown(),
      ...
      message = "Touchdown " + manager.getConfiguration().getTeam() + "!";
    } else {
      message = null;
    }
